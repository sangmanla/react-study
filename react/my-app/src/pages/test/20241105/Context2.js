...
const ImageSizeLargeContext = createContext(false);
...
export default function Context2() {
  ...
  return (
    <>
      ...
      <hr />
      <ImageSizeLargeContext.Provider value={isLarge}>
        <List />
      </ImageSizeLargeContext.Provider>
    </>
  );
}
...
function PlaceImage({ place }) {
  const isLarge = useContext(ImageSizeLargeContext);
